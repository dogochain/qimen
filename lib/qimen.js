 ...
 * 加4害
 */
const FourHarm = require('./fourHarm');
...
function calculate(date, options = {}) {
    ...
    try {
        ...
        const anGan = calculateAnGan(baMenResult.baMen, diPan, juShu.type);
         ...
         // ====================== 新增：4害計算 ======================
        const fourHarmModule = new FourHarm({
            jiuGongAnalysis: jiuGongAnalysis,
            sanQiLiuYi: sanQiLiuYi,
            kongWangGong: kongWangGong,
            maStar: maStar
        });
        const fourHarm = fourHarmModule.getAllHarm();
        // ====================== 4害計算結束 ======================
